<template>
  <nav-and-footer>
    <div class="w-full max-w-screen-lg mx-auto space-y-4 p-16 box-border">
      ...
      <p>
        ...
        <a href="https://graphql.org/" target="_blank">official docs</a> to learn more.
      </p>
  ...
  --data '{"query":"{\n  searchShows(search: \"spider\", limit: 10) {\n    id\n    name\n    originalName\n  }\n}\n"}'</code></pre>
      ...
      <p>
        Head over to the
        <a href="http://test.api.anime-skip.com/graphiql" target="_blank"
      ...
      <ul class="list-disc space-y-2">
        <li class="ml-8"><p>Production accounts are not present</p></li>
        <li class="ml-8"><p>Production data is not available</p></li>
        <li class="ml-8">
          <p>Data (except for accounts) is deleted every once in a while</p>
        </li>
        <li class="ml-8">
          <p>The <code>X-Client-ID</code> header is not required</p>
        </li>
      </ul>
...
mutation {
  createAccount(
    ...
    account {
      ...
      <ul class="list-disc space-y-2">
        <li class="ml-8">
          <p>The <code>X-Client-ID</code> header is required</p>
        </li>
        <li class="ml-8">
          <p>Some queries cannot be called by third party clients</p>
        </li>
      </ul>
      <p>
      ...
      <ul class="list-disc space-y-2">
        ...
        <li class="ml-8">
          <p>Account email tied to username</p>
        </li>
        <li class="ml-8">
          <p>Description of what you're using the API for</p>
        </li>
      </ul>
      <p>If you still don't want to get a unique one for yourself, you can use this one:</p>
